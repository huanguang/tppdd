...
<script>
    layui.use(['jquery'], function() {
        ...
        $("#submitForm").on('click',function () {
            ...
            $.post('<?php echo url('pinduoduo/onekey'); ?>',{
                content:content
            },function (res) {
                layer.close(msg);
                if (res.status){
