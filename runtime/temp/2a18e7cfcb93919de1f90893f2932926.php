...
<script>
    layui.use(['form','jquery','table'], function(){
        ...
        table.render({
            elem: '#bank'
            ,url:'<?php echo url('pinduoduo/bank'); ?>'
            ,page: true
            ,cellMinWidth: 80
            ,cols: [[
        ...
        table.on('edit(bank)', function(obj){
            ...
            if (field=='title'){
                ...
                if (flag) {
                    $.ajax({
                        type:"POST",
                        url: "<?php echo url('pinduoduo/bank_retitle'); ?>",
                        data:{
                            id:id
                            ,title:title
                        },
            ...
            if (field=='name') {
                ...
                if (flag) {
                    $.post('<?php echo url('pinduoduo/bank_rename'); ?>', {
                        id: id,
                        name: name
                    }, function (res) {
                        console.log(res);
            ...
            if (field=='address') {
                ...
                if (flag) {
                    $.post('<?php echo url('pinduoduo/bank_readdress'); ?>', {
                        id: id,
                        address: address
                    }, function (res) {
                        console.log(res);
    ...
    {
        location.href = '<?php echo url('bank_del'); ?>?id=' + id
    }
</script>
                    </div>
                </div>
