...
<script>
    layui.use(['form','jquery','table'], function(){
        ...
        table.render({
            elem: '#users_public'
            ,url:'<?php echo url('pinduoduo/users_public'); ?>'
            ,page: true
            ,cellMinWidth: 80
            ,cols: [[
