...
<div class="layui-form">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input layui-bg-gray" value="<?php echo htmlentities($secret); ?>" readonly/>
        </div>
    </div>
</div>
...
<script>
    jQuery(function(){
        jQuery('#output').qrcode({
            width: 200,
            height: 200,
            text: '<?php echo htmlentities($qrCodeUrl); ?>'
        });
    });
</script>
<?php endif; ?>
