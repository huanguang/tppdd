...
<script>
    layui.use(['form','jquery','table'], function(){
        ...
        table.render({
            elem: '#after_sales'
            ,url:'<?php echo url('pinduoduo/after_sales'); ?>'
            ,page: true
            ,cellMinWidth: 80
            ,cols: [[
