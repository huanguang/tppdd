...
<script>
    layui.use(['jquery','layer','element','form'], function() {
        ...
        $("#nextForm").on('click',function () {
            ...
            $.post('<?php echo url('pinduoduo/users_add'); ?>',{
                phone:phone,
                code:code
            },function (res) {
                layer.close(msg);
