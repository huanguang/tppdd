...
<?php endif; switch($hisiTabType): case "1": ?>
    ...
    <thead>
    <tr>
        <th colspan="2">欢迎您，<?php echo htmlentities($login['nick']); ?></th>
    </tr>
    </thead>
    <tbody>
    <tr>
        <td align="right">角色</td>
        <td><?php echo htmlentities($login['role_name']); ?></td>
    </tr>
