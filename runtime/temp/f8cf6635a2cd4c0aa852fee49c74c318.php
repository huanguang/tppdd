...
<div class="layui-form">
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="stores_id" lay-search="">
        ...
        <div class="layui-form-mid layui-word-aux">若没有店铺，请先<a href="<?php echo url('pinduoduo/stores_add'); ?>">【添加店铺】</a></div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">商品链接：</label>
        <div class="layui-input-inline" style="width: 600px;">
            <textarea style="height: 138px;padding-top: 10px;" class="layui-input" name="goods_url" placeholder="添加多个商品(每个请转行,最多20条)"  id="" cols="30" rows="20"></textarea>
        </div>
...
<script>
    layui.use(['jquery','layer'], function() {
        ...
        $("#submitForm").on('click',function () {
            ...
            let goods_url=$("textarea[name='goods_url']").val();
            if (!stores_id) {
                layer.msg('请选择店铺！', {
                    time: 3000, //20s后自动关闭
                    btn: ['知道了'],
            ...
            $.post('<?php echo url('pinduoduo/get_goods_info'); ?>',{
                stores_id:stores_id,
                goods_url:goods_url
            },function (res) {
                layer.close(msg);
                ...
                if (res.status){
                    ...
                    self.location='<?php echo url('pinduoduo/goods'); ?>';
                }else{
                    layer.msg(res.msg, {
                        time: 2000,
                        btn: ['知道了'],
