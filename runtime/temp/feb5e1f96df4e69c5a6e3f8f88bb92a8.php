...
<script>
    layui.use(['jquery'], function() {
        ...
        $("#submitForm").on('click',function () {
            ...
            $.post('<?php echo url('pinduoduo/bank_add'); ?>',{
                title:title,
                name:name,
                address:address
            },function (res) {
                ...
                if (res.status){
                    ...
                    self.location='<?php echo url('pinduoduo/bank'); ?>';
                }else{
                    layer.msg(res.msg, {
                        time: 2000,
                        btn: ['知道了'],
