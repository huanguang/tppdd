...
<script type="text/html" id="toolbar">
    <div class="layui-btn-group fl">
        <a data-href="<?php echo url('goods_status?val=1'); ?>" class="layui-btn layui-btn-primary layui-btn-sm hisi-page-btns layui-icon layui-icon-play" data-table="dataTable">&nbsp;启用</a>
        <a data-href="<?php echo url('goods_status?val=0'); ?>" class="layui-btn layui-btn-primary layui-btn-sm hisi-page-btns layui-icon layui-icon-pause" data-table="dataTable">&nbsp;禁用</a>
        <a data-href="<?php echo url('goods_delall'); ?>" class="layui-btn layui-btn-primary layui-btn-sm hisi-page-btns layui-icon layui-icon-delete" data-table="dataTable">&nbsp;删除</a>
    </div>
</script>
...
<script type="text/html" id="buttonTpl">
    <div class="layui-btn-group">
        ...
        <?php if(false): ?><a data-id="{{d.id }}" lay-event="goods_move" style="margin-left: 10px !important;" class="goods-move-btn layui-btn layui-btn-danger layui-btn-xs">移动</a><?php endif; if(false): ?><a href="javascript:goods_del({{d.id }});" style="margin-left: 10px !important;" class="layui-btn layui-btn-warm layui-btn-xs">删除</a><?php endif; ?>
    </div>
</script>
<script type="text/html" id="btnTpl">
    <div class="layui-btn-group">
        <a href="javascript:void(0);" onclick="goods_del({{d.id }});" style="margin-left: 10px !important;background-color:red;" class="layui-btn layui-btn-warm layui-btn-xs">删除</a>
    </div>
</script>
<script>
    layui.use(['form','jquery','table'], function(){
        ...
        table.render({
            elem: '#dataTable'
            ,url:'<?php echo url('pinduoduo/goods'); ?>'
            ,page: true
            ,cellMinWidth: 80
            ,toolbar: '#toolbar'
            ,cols: [[
        ...
        form.on('switch(StatusSwitch)', function(data){
            ...
            $.post('<?php echo url('pinduoduo/goods_status'); ?>',{
                id:id,
                val:status
            },function (res) {
                console.log(res);
        ...
        form.on('switch(IsUpperSwitch)', function(data){
            ...
            $.post('<?php echo url('pinduoduo/goods_is_upper'); ?>',{
                id:id,
                is_upper:is_upper
            },function (res) {
                console.log(res);
        ...
        table.on('tool(goods)', function(obj){
            ...
            if (event=='goods_move'){
                ...
                html+='<option value="<?php echo htmlentities($vo['id']); ?>"><?php echo htmlentities($vo['name']); ?></option>';
                <?php endforeach; endif; else: echo "" ;endif; ?>
                ...
                layer.open({
                    ...
                    ,yes: function(){
                        ...
                        if (flag){
                            $.ajax({
                                type:"POST",
                                url: "<?php echo url('pinduoduo/goods_move'); ?>",
                                data:{
                                    id:id
                                    ,stores_id:stores_id
                                },　
    ...
    function goods_del(id) {
        if (confirm('确认是否删除？')==true){
            self.location='<?php echo url('pinduoduo/goods_del'); ?>?id='+id;
        }
    }
